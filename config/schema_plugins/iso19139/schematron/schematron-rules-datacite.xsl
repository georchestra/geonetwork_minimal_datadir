...
<xsl:if test="$identifier != ''">
      ...
      <xsl:variable name="numberOfCreators"
                    select="count(gmd:identificationInfo/*/gmd:pointOfContact/*[gmd:role/*/@codeListValue = ('pointOfContact', 'custodian')])"/>
...
<xsl:if test="$publisher != ''">
      ...
      <xsl:variable name="publicationDate"
                    select="string-join(gmd:identificationInfo/*/gmd:citation/*/gmd:date/*[gmd:dateType/*/@codeListValue = 'publication'], ', ')"/>
...
<xsl:if test="$publicationDate != ''">
      ...
      <xsl:variable name="type" select="string-join(gmd:hierarchyLevel/*/@codeListValue, ', ')"/>
